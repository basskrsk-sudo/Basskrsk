...
// Для единого сценария ЮKassa заранее неизвестно, какой способ выберет клиент.
// В прогнозе используем консервативную карточную ставку.
const FEE_RATE = { card: 0.025, bank_card: 0.025, sbp: 0.007, yookassa: 0.025 };
